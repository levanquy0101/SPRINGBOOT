package com.example.myappbe.initializer;
...
import com.example.myappbe.services.IUserService;
...
//        this.passwordEncoder = passwordEncoder;
    ...
    private void createDefaultRoles() {
        String[] roleNames = {"ROLE_ADMIN", "ROLE_MANAGER",};
    ...
    private void createDefaultAdmin() {
        if (!iUserService.existsByUsername("admin")) {
            ...
            admin.setAvatarUrl("https://avatars.githubusercontent.com/u/138227498?s=400&u=933ddd7cd94991150a3267b8e3965aeb21be2b31&v=4");
